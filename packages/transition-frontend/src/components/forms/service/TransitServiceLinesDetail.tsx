...
export interface TransitServiceLinesDetailProps {
    service: Service;
    paths: GeoJSON.FeatureCollection<GeoJSON.LineString, PathAttributes>;
}

const TransitServiceLinesDetail: React.FunctionComponent<TransitServiceLinesDetailProps> = (
    props: TransitServiceLinesDetailProps
) => {
    console.log('ServiceLinesDetail rendered with paths:', props.paths);
    ...
    return (
        <table className="_statistics" key="ServiceLinesDetail">
            <tbody>
